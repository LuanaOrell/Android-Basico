...
public class Alarm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ediFecha = (EditText) findViewById(R.id.editFcecha);
        ediHora = (EditText) findViewById(R.id.editHora);
        loadNowTime();
    }
    ...
    public void addAlarm(View view) {
        ...
        Toast.makeText(this, "Alarma añadida", Toast.LENGTH_SHORT).show();
    }
    ...
    private DatePickerDialog.OnDateSetListener mDateSetListener = new DatePickerDialog.OnDateSetListener() {
        public void onDateSet(DatePicker view, int year, int monthOfYear,
                              int dayOfMonth) {
            Alarm.this.year = year;
            Alarm.this.month = monthOfYear;
            Alarm.this.day = dayOfMonth;
            updateDate();
            updateCalendar();
        }
    };
    ...
    private TimePickerDialog.OnTimeSetListener mTimeSetListener = new TimePickerDialog.OnTimeSetListener() {
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            Alarm.this.hour = hourOfDay;
            Alarm.this.minute = minute;
            updateTime();
            updateCalendar();
        }
    };
    ...
    private void updateDate() {
        ediFecha.setText(new StringBuilder()
                .append(day)
                .append("-")
                .append(month + 1)
                .append("-")
    ...
    private void updateTime() {
        ediHora.setText(new StringBuilder().append(pad(hour)).append(":").append(pad(minute)));
    }
